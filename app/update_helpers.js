...
function initAutoUpdater () {
  ...
  /
  /
  / After a build, the RELEASES file in the updates bucket must be updated with content 
  / from the new RELEASES file and the new .nupkg file must be renamed and moved to the
  / updates bucket. The .exe file generated by a build is the installer and can go in the
  / corresponding version folder associated with the releases bucket.
  /
  / LINK:
